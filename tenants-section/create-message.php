            ...
            <form>
              <div class="row">
                <div class="form-group col-lg-12">
                  ...
                  <textarea placeholder="Click Here To Reply" class="form-control" rows="10"></textarea>
                </div>
                <div class="form-group col-lg-12">
                    <a target="_blank" href=""><button type="submit" class="btn btn-success float-right">Send Message</button></a>
                </div>
              </div>
            </form>
          </div>
