  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0"><strong>Report This User</strong>
        </h2>
        <hr class="divider">
            <div class="form">
                <form>
                  <div class=" col-lg-12">
                    <label class="text-heading"><strong>Attempt to pay or communicate outside StudentsHousing.com</strong></label>
                      <input type="radio" name="offense">
                  </div>
                  <div class=" col-lg-12">
                    <label class="text-heading"><strong>Suspicion of fraud</strong></label>
                      <input type="radio" name="offense">
                  </div>
                  <div class=" col-lg-12">
                    <label class="text-heading"><strong>Discriminatory or hateful content</strong></label>
                      <input type="radio" name="offense">
                  </div>
                  <div class=" col-lg-12">
                    <label class="text-heading"><strong>Other</strong></label>
                      <input type="radio" name="offense">
                      <textarea class="form-control" rows="6" placeholder="Please describe the reason"></textarea>
                  </div>
                ...
                <p>Please choose one of the above reasons and our dedicated Trust and Safety team will look into it.</p>
          </div>
      </div>
