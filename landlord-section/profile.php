<?php 
  ...
  $landlord = User::find($session->user_id);
  $age = User::getAge($landlord->dob);
        ...
        <div class="bg-faded p-4 my-4">
          <hr class="divider">
            <h2 class="text-center text-lg text-uppercase my-0">
              <strong><?php echo "$landlord->first_name"; ?> Profile</strong>
            </h2>
          <hr class="divider">
            <div class="row">
              <div class="col-lg-8">
                <div class="bg-faded p-4 my-4">
                  <hr class="divider">
                    <h2 class="text-center text-lg my-0">
                      <strong>Learn About <?php echo "$landlord->first_name"; ?></strong>
                    </h2>
                  <hr class="divider">
                ...
                <div class="card h-100">
                  <img class="card-img-top img-fluid" src="img/empty_profile.png" alt="">
                    <div class="card-body text-center">
                      <h4 class="card-title m-0"><?php echo "$landlord->first_name $landlord->last_name"; ?>
                        <hr class="divider">
                          <small class="text-muted"><strong>Username:</strong> <?php echo "$landlord->username"; ?></small><br>
                        <hr class="divider">
                          <small class="text-muted"><strong>Address:</strong> <?php echo "$landlord->address "; ?></small><br>
                        <hr class="divider">
                          <small class="text-muted"><strong>Age:</strong> <?php echo "$age"." "; ?> years</small>
                        <hr class="divider">
                          <small class="text-muted"><strong>Email:</strong> <?php echo "$landlord->email "; ?></small><br>
                        <hr class="divider">
