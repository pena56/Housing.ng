      ...
      <div class="bg-faded p-4 my-4">
          <hr class="divider">
            <h2 class="text-center text-lg text-uppercase my-0">
              <strong>Uploaded Property</strong>
            </h2>
          <hr class="divider">
            ...
            <div class="bg-faded p-4 my-4 col-md-6">
              <div class="card card-inverse">
                ...
                <div class="card-img-overlay bg-overlay">
                  ...
                  <a href="edit-details.php" class="btn btn-success">Edit Details</a>
                  <a href="#" class="btn btn-danger float-right" data-toggle="modal" data-target="#myModal">Remove</a>
                </div>
              </div>
            </div>
              ...
              <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    <h6 class="modal-title">Are You Sure You want to Delete This Property?</h6>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                  </div>
                  <div class="modal-body">
                    <a href="#" class="btn btn-primary">Yes</a>
                    <a href="#" class="btn btn-warning float-right">No</a>
                  </div>
                </div>
          ...
          <div class="form-group col-lg-12">
              <a target="_blank" href="add-new.php"><button type="submit" class="btn btn-warning float-right">Add New</button></a>
          </div>
      </div>
